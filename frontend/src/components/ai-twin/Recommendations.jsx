...
export default function Recommendations() {
  const recs = [
    ...
    { id: 2, type: 'success', icon: CheckCircle2, color: 'text-[#c6ff00]', bg: 'bg-[#c6ff00]/20', text: "Great job! You saved ₹15,000 extra this month. I recommend moving this to your Emergency Fund." },
    { id: 3, type: 'info', icon: Info, color: 'text-[#4d7cfe]', bg: 'bg-[#4d7cfe]/20', text: "Market conditions for your mutual fund portfolio are favorable. Consider increasing your SIP by 5%." },
  ]
          ...
          <div key={rec.id} className="flex gap-4 p-4 rounded-xl glass border-slate-700/50 hover:bg-slate-800 transition-colors">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 flex gap-2">
                <button className="text-xs font-medium text-[#c6ff00] bg-[#c6ff00]/10 px-3 py-1.5 rounded-full hover:bg-[#c6ff00]/20 transition-colors">
                  Take Action
                </button>
